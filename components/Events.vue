<template>
  <v-container fluid>
    <v-row>
      <v-col cols="12" lg="4" md="6" sm="12" v-for="(event, i) in allEvents" :key="i">
        <v-card height="488" flat outlined :to="`/events/${event.id}`">
          ...
          <div class="d-flex font__10 mx-4 my-6 primary--text font-weight-medium">
